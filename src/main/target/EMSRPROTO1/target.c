...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TMR4, CH1, PB6, TIM_USE_MOTOR, 0, 0, 1),                 // motor1 DMA1 CH1
    DEF_TIM(TMR4, CH2, PB7, TIM_USE_MOTOR, 0, 2, 1),                 // motor2 DMA1 CH3
    DEF_TIM(TMR4, CH3, PB8, TIM_USE_MOTOR, 0, 1, 0),                 // motor3 DMA1 CH2
    DEF_TIM(TMR4, CH4, PB9, TIM_USE_MOTOR, 0, 3, 0),                 // motor4 DMA1 CH4
