...
#define TARGET_BOARD_IDENTIFIER "HFRC"
#define USBD_PRODUCT_STRING     "HIFLYF435-WING"
//LEDS
...
#define SERIAL_PORT_COUNT       5 // VCP  UART1 UART2 UART3 UART5 UART7 SOFTSERIAL 1/2
...
#define CURRENT_METER_SCALE_DEFAULT 9540
