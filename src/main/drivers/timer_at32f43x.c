...
// Port A
    ...
    DEF_TIM(TMR3, CH2, PA4, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH1, PA6, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH2, PA7, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH1, PA15, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH1N, PA7, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH2, PA14, TIM_USE_ANY, 0, 0, 0),
    ...
    DEF_TIM(TMR1, CH1N, PA11, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR1, CH2N, PA12, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR2, CH3, PA9, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR2, CH4, PA10, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR4, CH1, PA11, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR4, CH2, PA12, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR4, CH3, PA13, TIM_USE_ANY, 0, 0, 0),
...
// Port B
    ...
    DEF_TIM(TMR5, CH1, PB2, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH1, PB4, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH2, PB5, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR4, CH1, PB6, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR4, CH2, PB7, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR4, CH3, PB8, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR4, CH4, PB9, TIM_USE_ANY, 0, 0, 0),

    DEF_TIM(TMR20, CH1, PB2, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH3N, PB5, TIM_USE_ANY, 0, 0, 0),

    DEF_TIM(TMR8, CH2N, PB0, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH3N, PB1, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH1N, PB3, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH2N, PB4, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR1, CH3N, PB15, TIM_USE_ANY, 0, 0, 0),
    
    DEF_TIM(TMR8, CH1, PB6, TIM_USE_ANY, 0, 0, 0),
    ...
    DEF_TIM(TMR3, CH4, PB7, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH2, PB8, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH3, PB9, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR1, CH3N, PB9, TIM_USE_ANY, 0, 0, 0),

// Port C
    DEF_TIM(TMR5, CH2, PC12, TIM_USE_ANY, 0, 0, 0),

	DEF_TIM(TMR1, CH1, PC0, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR1, CH2, PC1, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR1, CH3, PC2, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR1, CH4, PC3, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH1, PC6, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH2, PC7, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH3, PC8, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR3, CH4, PC9, TIM_USE_ANY, 0, 0, 0),
    ...
    DEF_TIM(TMR8, CH1N, PC10, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH2N, PC11, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR8, CH3N, PC12, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR1, CH1N, PC13, TIM_USE_ANY, 0, 0, 0),

    DEF_TIM(TMR20, CH2, PC2, TIM_USE_ANY, 0, 0, 0),
    DEF_TIM(TMR20, CH3, PC8, TIM_USE_ANY, 0, 0, 0),
};
#endif
