...
//    TIM_SetAutoreload(timer, (timerState.intervalUs / TICK_TOCK_COUNT) - 1);
    ...
    tmr_period_value_set(timer, (timerState.intervalUs / TICK_TOCK_COUNT) - 1);
...
//#endif
        tmr_period_value_set(timer, adjustedPeriod - 1);
...
//#endif
	tmr_interrupt_enable(timer,TMR_OVF_INT,DISABLE);
...
//#endif
    tmr_period_value_set(timer,(timerState.intervalUs / TICK_TOCK_COUNT));
    tmr_counter_value_set(timer,0);
